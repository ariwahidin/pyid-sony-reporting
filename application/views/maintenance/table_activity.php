<table style="font-size: 12px;" class="table display compact table-responsive table-nowrap table-bordered table-striped align-middle mb-0" id="tableCompleteActivities">
    <thead>
        <tr>
            <th scope="col">NO.</th>
